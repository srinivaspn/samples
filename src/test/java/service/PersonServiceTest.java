...
public class PersonServiceTest {
    ...
    public void groupByAge_returnbyGrouping() {
        Person person1 = Person.builder().setFirstName("Srinivas").setLastName("Penukonda").setAge(35).build();
        Person person2 = Person.builder().setFirstName("Abhinav").setLastName("Mathur").setAge(35).build();
